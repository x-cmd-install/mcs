...
[![x-cmd/install — mcs Code Quality Monitoring Repo Card](https://x-cmd.com/repo-card/mcs.svg?lang=zh)](https://x-cmd.com/install/mcs)
...
合计: **4,916** 行代码（覆盖前 5 种语言、共 **95** 个文件）。
...
- **上游仓库**: <https://github.com/mthmulders/mcs>
- **官网**: <https://maarten.mulders.it/projects/mcs/>
- **许可证**: MIT
...
- **Star**: 207 · **Fork**: 30 · **开放 issue**: 71 · **贡献者**: 6

## 累计统计

- **发布数**: 66 · **已合并 PR**: 417 · **开放 PR**: 6 · **已关闭 issue**: 55 · **开放 issue**: 16 · **提交数**: 880

## 最近活动

| 时间窗口 | 起始 | 发布 | 已合并 PR | 开放 PR | 已关闭 issue | 开放 issue | 提交 |
|---|---|---:|---:|---:|---:|---:|---:|
| 30d | 2026-08-27 | 2 | 2 | 5 | 0 | 0 | 6 |
| last60d | 2026-07-28 | 3 | 10 | 5 | 0 | 1 | 17 |
| 90d | 2026-06-28 | 4 | 24 | 5 | 1 | 2 | 43 |
| last180d | 2026-03-30 | 6 | 51 | 5 | 3 | 2 | 82 |
| 360d | 2025-10-01 | 18 | 112 | 5 | 5 | 3 | 240 |
| last720d | 2024-10-06 | 25 | 195 | 5 | 16 | 6 | 358 |
...
mcs 的安装元数据由 [x-cmd/install](https://github.com/x-cmd/install) 索引维护——这是一份由 x-cmd 在安装时读取的精选 YAML 包列表。如果 `mcs` 缺失、过期，或安装行为有问题，欢迎在该 repo 提 issue 或 PR：

- **提交 issue**: <https://github.com/x-cmd/install/issues/new>
- **编辑包条目**: <https://github.com/x-cmd/install/edit/main/mcs.yml>（或索引实际使用的路径）

本页面的数据（card / loc / scorecard / release）由 [x-cmd-install-action](https://github.com/x-cmd-install/x-cmd-install-action) 自动采集，每日重新生成。**安装行为**（版本选择、平台差异、依赖处理）的改进应提交到上游索引。

_数据快照: `data/card/260926.yml` · 2026-09-26T06:13:32Z._
